...
import bee.com.nascent.maven.plugin.process.BeeApplication;
import bee.com.nascent.maven.plugin.process.BeeAsserts;
import bee.com.nascent.maven.plugin.process.BeeJunitAsserts;
...
public class XXXControllerTest {
    ...
    public static class XMethodDelegate
        extends AbstractBeeMethodDelegate {
    ...
    public static void main(String[] args) throws Throwable {
        BeeAsserts<XXP> xx = XXXControllerTest.xMethod()
            .args()
            .param("xx")
            .toRequestBody()
            .mock(new XXP())
