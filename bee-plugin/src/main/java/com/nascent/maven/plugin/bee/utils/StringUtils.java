 ...
 * @author zhangmsh
 */
@SuppressWarnings({"java:S3358", "java:S127", "java:S125"})
public final class StringUtils {
  ...
  public static String removeStart(String str, String remove, boolean ignoreCase) {
    int rl;
    if (str == null || str.length() == 0 || remove == null || (rl = remove.length()) == 0) {
      return str;
    }
  ...
  public static String removeEnd(String str, String remove) {
    int sl;
    int rl;
    if (str == null || (sl = str.length()) == 0 || remove == null || (rl = remove.length()) == 0) {
      return str;
    }
   ...
   * @param end 结束位置，如果小于0=0，如果大于原始字符串的长度，则为字符串的长度 如果 end > start 则二者互换。
   * @return
   */
  ...
  public static int countMatches(String str, String sub) {
    int subLen;
    if (str == null || str.length() == 0 || sub == null || (subLen = sub.length()) == 0) {
      return 0;
    }
    int count = 0;
    int idx = 0;
  ...
  public static int countMatches(String str, char ch) {
    ...
    int count = 0;
    // We could also call str.toCharArray() for faster look ups
    // but that would generate more garbage.
    for (int i = 0; i < len; i++) {
      if (ch == str.charAt(i)) {
        count++;
      }
  ...
  public static String abbreviateMiddle(String str, String middle, int length) {
    int sl;
    int ml;
    if (str == null || (sl = str.length()) == 0 || middle == null || (ml = middle.length()) == 0) {
      return str;
    }
