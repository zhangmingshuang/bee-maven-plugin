...
public class BeeXml {
  ...
  public static BeeXml from(InputStream inputStream) throws IOException, SAXException {
    ...
    SetNextRule setNextRule =
        new SetNextRule("testOne", Object.class.getName()) {
          private String body;
    ...
    digester.addObjectCreate(
        "project/dependencyManagement/dependencies/dependency", BeeDependency.class);
    digester.addSetNext(
        "project/dependencyManagement/dependencies/dependency", ADD_DEPENDENCY_MANAGEMENT);
    ...
    digester.addSetNext("project/dependencies/dependency/exclusions", SET_EXCLUSIONS);
    digester.addObjectCreate(
        "project/dependencies/dependency/exclusions/exclusion", BeeExclusion.class);
    digester.addSetNext("project/dependencies/dependency/exclusions/exclusion", LIST_ADD);
    digester.addBeanPropertySetter(
