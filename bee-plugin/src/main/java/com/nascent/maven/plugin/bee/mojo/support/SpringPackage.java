...
public class SpringPackage {
    ...
    public static final String REQUEST_METHOD_POST = "org.springframework.web.bind.annotation.RequestMethod.POST";
    public static final String REQUEST_METHOD_GET = "org.springframework.web.bind.annotation.RequestMethod.GET";
