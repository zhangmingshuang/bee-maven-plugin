...
public class PojoBuilder<T> {
    ...
    public <P1, P2, P3, P4> PojoBuilder<T> with(Consumer4<T, P1, P2, P3, P4> consumer, P1 p1, P2 p2,
        P3 p3, P4 p4) {
    ...
    public <P1, P2, P3, P4, P5> PojoBuilder<T> with(Consumer5<T, P1, P2, P3, P4, P5> consumer, P1 p1,
