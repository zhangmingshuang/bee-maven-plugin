...
public interface BeeAsserts<T> {
    ...
    default bee.com.nascent.maven.plugin.BeeAsserts<T> isTrue(Function<T, Boolean> fun) {
        return this.isTrue(fun, "assert that the value of function is true,"
            + "but unexpected. body: " + bodyJson());
    }
    ...
    default bee.com.nascent.maven.plugin.BeeAsserts<T> isFalse(Function<T, Boolean> fun) {
        return this.isFalse(fun, "assert that the value of function is false,"
            + "but unexpected. body: " + bodyJson());
    }
    ...
    default bee.com.nascent.maven.plugin.BeeAsserts<T> isEquals(Function<T, Object> fun, Object eqValue) {
        return this.isEquals(fun, eqValue,
            "expect is " + fun.apply(body()) + " but " + eqValue);
    }

    bee.com.nascent.maven.plugin.BeeAsserts<T> isEquals(Function<T, Object> fun, Object eqValue, String message);
    ...
    bee.com.nascent.maven.plugin.BeeAsserts<T> isEquals(Function<T, Long> fun, long eqValue, String message);

    default bee.com.nascent.maven.plugin.BeeAsserts<T> isEquals(Function<T, Float> fun, float eqValue) {
        return this.isEquals(fun, eqValue,
            "expect is " + fun.apply(body()) + " but " + eqValue);
    }

    bee.com.nascent.maven.plugin.BeeAsserts<T> isEquals(Function<T, Float> fun, float eqValue, String message);

    default bee.com.nascent.maven.plugin.BeeAsserts<T> isEquals(Function<T, Double> fun, double eqValue) {
        return this.isEquals(fun, eqValue,
            "expect is " + fun.apply(body()) + " but " + eqValue);
    }

    bee.com.nascent.maven.plugin.BeeAsserts<T> isEquals(Function<T, Double> fun, double eqValue, String message);
